...
public class StudentTester {
   public static void main(String[] args) {
      ...
      System.out.println("Average [exp: 0.0]: " + stud1.getAverage());
      ...
      System.out.println("Average [exp: 0.0]: " + stud2.getAverage());
      ...
      System.out.print("Student name and total score: ");
      System.out.println(stud1.getName() + " " + stud1.getTotalScore());
      System.out.println("Average [exp: 10.0]: " + stud1.getAverage());
      ...
      System.out.print("Student name and total score: ");	
      System.out.println(stud1.getName() + " " + stud1.getTotalScore());
      System.out.println("Average [exp: 8.8]: " + stud1.getAverage());
