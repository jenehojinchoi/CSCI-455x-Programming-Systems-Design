...
public class Bar {
   ...
   */
   public void draw(Graphics2D g2) {
      // calculate the object of pixel range to measure the width and height of the label
      Font font = g2.getFont();
      FontRenderContext context = g2.getFontRenderContext();
      Rectangle2D labelBounds = font.getStringBounds(label, context);

      // calculate the width and height of label
      int widthOfLabel = (int)labelBounds.getWidth();
      int heightOfLabel = (int)labelBounds.getHeight();

      // specify upper-left corner of bar (Rectangle)
      int barWidth = width;
      int barHeight = (int)(applicationHeight * scale);

      // specify upper-left corner of bar (Rectangle)
      int barX = left;
      int barY = bottom - heightOfLabel - barHeight;
      ...
      // calculate x,y coordinates of label
      int labelX = left + (width / 2) - (widthOfLabel / 2);
      int labelY = bottom + 3;
